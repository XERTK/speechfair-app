...
import { useGetConsumersQuery } from '@/store/consumer';
...
const ConsumerPage = () => {
  ...
  const { data } = useGetConsumersQuery<any>(query);

  console.log('hello from the consumers API', data?.results);
  return (
    <Box
      component="main"
      sx={{
      ...
      <Container maxWidth="xl">
        <Stack spacing={3}>
          <Stack direction="row" spacing={1}>
            ...
            <NextLink href="/admin/consumers/add">
              <Button
                startIcon={
...
ConsumerPage.getLayout = (page: any) => (
